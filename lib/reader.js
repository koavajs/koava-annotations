...
var Reader = function(registry){
	...
	/**
	 * Clear all currently hold annotations
	 * 
	 * @returns {Array}
	 */
	this.clearAnnotations = function(){
		__constructorAnnotations.length = 0;
		__methodAnnotations.length = 0;
		__propertyAnnotations.length = 0;
	};
	 ...
	 */
	var __parseConstructorAnnotations = function(target, comment, filePath){
	 ...
	 * @param {String} filePath
	 */
	var __parseMethodAnnotations = function(target, comment, filePath){
	 ...
	 * @param {String} filePath
	 */
	var __parsePropertyAnnotations = function(target, comment, filePath){
	 ...
	 * @returns {void}
	 */
	var __createAnnotationMap = function(){
	 ...
	 * @returns {Array}
	 */
	var __parseAnnotations = function(target, comment, annotationsToFind, filePath){
